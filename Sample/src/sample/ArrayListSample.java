...
public class ArrayListSample {
	...
	public static void main(String[] args) {
		...
		//要素の取得
		String firstItem = places.get(0); //最初の要素の獲得
		...
		System.out.println("4番目の要素（削除前）" + places.get(3));
		places.remove(3);
		System.out.println("4番目の要素（削除後）" + places.get(3));
		
		//拡張forテーブルによる取得
		System.out.println("拡張forテーブルによる取得：");
